...
import com.connetz.connetz.services.FirebaseUserDetailsService;
...
public class FirebaseAuthenticationConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .allowCredentials(restSecProps.isAllowCredentials())
                .exposedHeaders(restSecProps.getExposedHeaders().toArray(String[][]::new))
                .and()
                // ... other security configuration using HttpSecurity
                .build();
    }
